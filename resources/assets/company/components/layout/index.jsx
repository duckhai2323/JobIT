    ...
    <div className={cx('layout-section')}>
      ...
      <div className={cx('layout-section__content')}>
        <div className={cx('layout-section__sidebar')}>
          <div className={cx('sidebar__title')}>TRANG QUẢN LÝ CÔNG TY</div>
          ...
          <div className={cx('sidebar__companydetail')}>
            <NavLink to='/company-detail' className={({ isActive }) => cx('nav-link', { active: isActive })}><button onClick={() => onChangeContent(2)} className={cx('sidebar__button')}>
              <span><CgOrganisation /></span> Thông tin công ty
            </button></NavLink>
          </div>
          <div className={cx('sidebar__users')}>
            <NavLink to='/employees' className={({ isActive }) => cx('nav-link', { active: isActive })}><button onClick={() => onChangeContent(3)} className={cx('sidebar__button')}>
              <span><FaUser /></span> Danh sách nhân viên
            </button></NavLink>
          </div>
